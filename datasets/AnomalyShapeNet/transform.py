...
# Shift point cloud center to origin (X/Y centered, Z shifted to z_min)
...
# Partition point cloud into spherical regions with mask labels and record region centers
