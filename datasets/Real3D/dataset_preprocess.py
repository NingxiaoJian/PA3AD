...
class ContrastiveDataset:
    def __init__(self, cfg):
        ...
        # Training data: PLY template files
        ...
        # Anomaly sample: full augmentation + sphere crop
    ...
    def trainMerge(self, id):
        ...
        for i, idx in enumerate(id):
            ...
            shifted_xyz = self.generate_pseudo_anomaly(shift_xyz, shift_normal, centers[shift_index[0]],
                                                      distance_to_move=np.random.uniform(0.06, 0.10))
